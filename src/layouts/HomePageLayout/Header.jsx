...
const Header = () => {
  ...
  return (
    <div className='w-full bg-[#fff] fixed z-10 h-[102px] px-[104px] py-[23px]'>
            ...
            </div>
            {
                ...
                <div className='w-[319px] h-[56px] flex items-center gap-2 justify-between'>
                    <button className='bg-transparent w-[114px] h-[56px] flex items-center justify-center '>
                        <p className='hover:text-[#3E5EA9] text-[#25324B] font-euclid text-base font-medium'>Sign In</p>
                    </button>
                    ...
                    <button className='bg-transparent w-[185px] h-[56px] flex items-center justify-center'>
                        <p className='text-[#25324B] hover:text-[#3E5EA9] font-medium text-base font-euclid'>Employer/Post Job</p>
                    </button>
                </div>
                :
                <button
